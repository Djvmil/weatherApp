package com.side_project.weatherapp.data.repository

import com.side_project.weatherapp.data.datasource.local.db.CityLocalDataSource
import com.side_project.weatherapp.data.datasource.local.db.ForecastLocalDataSource
import com.side_project.weatherapp.data.datasource.remote.api.ForecastRemoteDataSource
import com.side_project.weatherapp.data.mapper.CityEntityMapper
import com.side_project.weatherapp.data.mapper.ForecastDtoMapper
import com.side_project.weatherapp.data.mapper.ForecastEntityMapper
import com.side_project.weatherapp.domain.model.City
import com.side_project.weatherapp.domain.model.Forecast
import com.side_project.weatherapp.domain.repository.ForecastRepository
